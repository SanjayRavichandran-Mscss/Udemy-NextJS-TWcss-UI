...
<h3 className="text-red-400 text-[24px] lg:text-[28px]">{title}</h3>
...
<h3 className="text-[24px] text-gray-500">
  ...
  <div className="bg-red-400 text-white text-[14px] md:text-[16px] p-2 px-4 rounded-lg inline-block cursor-pointer hover:bg-red-500">Shop Now</div>
     </div>
     <Image
