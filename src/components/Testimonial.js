      ...
      <div className="container py-16 grid-cols-2">
        ...
        <div className="grid lg:grid-cols-[300px,1fr] gap-4">
          <div className="border border-gray-300 rounded-2xl grid place-items-center p-6 lg:p-0">
            <div className="text-center flex flex-col item-center gap-1">
              ...
              <p className="max-w-[200px] text-gray-500">this is a long established fact that a reader will be distracted by the readable.   </p>
            </div>
          </div>
